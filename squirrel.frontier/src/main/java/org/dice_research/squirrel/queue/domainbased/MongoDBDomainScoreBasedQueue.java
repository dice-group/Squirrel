...
public class MongoDBDomainScoreBasedQueue extends MongoDBDomainBasedQueue {
    ...
    public MongoDBDomainScoreBasedQueue(String hostName, Integer port, boolean includeDepth, QueryExecutionFactory queryExecFactory) {
        ...
        this.uriKeywiseFilter = new ScoreBasedUriKeywiseFilter(uriScoreCalculator);
    }
    ...
    public MongoDBDomainScoreBasedQueue(String hostName, Integer port, Serializer serializer, boolean includeDepth, String sparqlEndpointUrl, String username, String password, UriDuplicityScoreCalculator uriScoreCalculator, ScoreBasedUriKeywiseFilter scoreBasedUriKeywiseFilter) {
        super(hostName, port, serializer, includeDepth);
        QueryExecutionFactory qef = getQueryExecutionFactory(sparqlEndpointUrl, username, password);
