...
public class FrontierSenderToWebservice implements Runnable, Closeable {
    ...
    private RelationalUriFilter relationalUriFilter;
     ...
     */
    public FrontierSenderToWebservice(RabbitQueueFactory factory, WorkerGuard workerGuard, UriQueue queue, RelationalUriFilter relationalUriFilter, URIReferences uriReferences) {
