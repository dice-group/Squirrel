 ...
 * 
 * Had to manually copy this class as it is not yet contained in package org.apache.jena.vocabulary
 * for the jena version currently used in SQUIRREL. 
 * Can be removed on migration of Jena to a newer version containing the vocabulary.
 */
public class DCAT
{
