package org.aksw.simba.squirrel.sink.impl.provenance;
...
public class SparqlBasedMetaDataSink implements Sink {

    private static String strContentDatasetUriQuery;
    @SuppressWarnings("unused")
    private static final Logger LOGGER = LoggerFactory.getLogger(SparqlBasedMetaDataSink.class);
    @SuppressWarnings("unused")
    ...
    public SparqlBasedMetaDataSink() {
        String strIP = "jena";
        String portVar = "PORT";
