...
public class HDFSSinkHelperConfiguration extends Configuration {
    ...
    public static final String HDFS_DESTINATION_DIRECTORY_HOST_KEY = "HDFS_REMOTE_HOST";
    ...
    public static HDFSSinkHelperConfiguration getHDFSHelperConfguration() throws Exception {
        ...
        String destinationdirectory = getEnv(HDFS_DESTINATION_DIRECTORY_HOST_KEY, LOGGER);
        if (hdfshost != null) {
            LOGGER.info("The worker will use " + HDFS_REMOTE_HOST_KEY + " as the HDFS host.");
            LOGGER.info("The worker will use " + HDFS_DESTINATION_DIRECTORY_HOST_KEY + " as the output directory.");
            ...
            String msg = "Couldn't get " + HDFS_REMOTE_HOST_KEY + " from the environment. "+
                "Couldn't get " + HDFS_DESTINATION_DIRECTORY_HOST_KEY + " from the environment. ";
            LOGGER.error(msg);
